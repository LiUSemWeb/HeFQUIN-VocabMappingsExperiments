...
new_uri_course="<http://www.global-example#Course>"
...
new_uri_GraduateStudent="<http://www.global-example#GraduateStudent>"
...
new_uri_Student="<http://www.global-example#Student>"
...
new_uri_Professor="<http://www.global-example#Professor>"
...
new_uri_Faculty="<http://www.global-example#Faculty>"
...
new_uri_supervisor="<http://www.global-example#supervisor>"
...
new_uri_worksAt="<http://www.global-example#worksAt>"
...
new_uri_teaches="<http://www.global-example#teaches>"
...
new_uri_phoneNumber="<http://www.global-example#phoneNumber>"
...
new_uri_email="<http://www.global-example#email>"
...
new_uri_researchTopic="<http://www.global-example#researchTopic>"
...
new_uri_memberOf="<http://www.global-example#memberOf>"
...
new_uri_isPartOf="<http://www.global-example#isPartOf>"
...
new_uri_writtenBy="<http://www.global-example#writtenBy>"
...
new_uri_degreeFrom="<http://www.global-example#degreeFrom>"
...
new_uri_registersCourse="<http://www.global-example#registersCourse>"
...
i=0
mkdir -p globalvocab_datasets
while [ "$i" -le 9 ];
do
  suffix="$i"
  sed "s/$escaped_old_uri_course/$escaped_new_uri_course/g" < original_datasets/University$suffix.nt > globalvocab_datasets/University$suffix.nt

  sed -i -e "s/$escaped_old_uri_UndergraduateStudent/$escaped_new_uri_Student/g" globalvocab_datasets/University$suffix.nt

  sed -i -e "s/$escaped_old_uri_TeachingAssistant/$escaped_old_uri_UndergraduateStudent/g" globalvocab_datasets/University$suffix.nt

  sed -i -e "s/$escaped_old_uri_ResearchAssistant/$escaped_old_uri_UndergraduateStudent/g" globalvocab_datasets/University$suffix.nt

  sed -i -e "s/$escaped_old_uri_AssistantProfessor/$escaped_new_uri_Professor/g" globalvocab_datasets/University$suffix.nt

  sed -i -e "s/$escaped_old_uri_AssociateProfessor/$escaped_new_uri_Professor/g" globalvocab_datasets/University$suffix.nt

  sed -i -e "s/$escaped_old_uri_FullProfessor/$escaped_new_uri_Professor/g" globalvocab_datasets/University$suffix.nt

  sed -i -e "s/$escaped_old_uri_Lecturer/$escaped_new_uri_Faculty/g" globalvocab_datasets/University$suffix.nt

  sed -i -e "s/$escaped_old_uri_advisor/$escaped_new_uri_supervisor/g" globalvocab_datasets/University$suffix.nt

  sed -i -e "s/$escaped_old_uri_worksFor/$escaped_new_uri_worksAt/g" globalvocab_datasets/University$suffix.nt

  sed -i -e "s/$escaped_old_uri_teacherOf/$escaped_new_uri_teaches/g" globalvocab_datasets/University$suffix.nt

  sed -i -e "s/$escaped_old_uri_telephone/$escaped_new_uri_phoneNumber/g" globalvocab_datasets/University$suffix.nt

  sed -i -e "s/$escaped_old_uri_emailAddress/$escaped_new_uri_email/g" globalvocab_datasets/University$suffix.nt

  sed -i -e "s/$escaped_old_uri_researchInterest/$escaped_new_uri_researchTopic/g" globalvocab_datasets/University$suffix.nt

  sed -i -e "s/$escaped_old_uri_memberOf/$escaped_new_uri_memberOf/g" globalvocab_datasets/University$suffix.nt

  sed -i -e "s/$escaped_old_uri_subOrganizationOf/$escaped_new_uri_isPartOf/g" globalvocab_datasets/University$suffix.nt

  sed -i -e "s/$escaped_old_uri_publicationAuthor/$escaped_new_uri_writtenBy/g" globalvocab_datasets/University$suffix.nt

  sed -i -e "s/$escaped_old_uri_doctoralDegreeFrom/$escaped_new_uri_degreeFrom/g" globalvocab_datasets/University$suffix.nt

  sed -i -e "s/$escaped_old_uri_mastersDegreeFrom/$escaped_new_uri_degreeFrom/g" globalvocab_datasets/University$suffix.nt

  sed -i -e "s/$escaped_old_uri_undergraduateDegreeFrom/$escaped_new_uri_degreeFrom/g" globalvocab_datasets/University$suffix.nt

  sed -i -e "s/$escaped_old_uri_takesCourse/$escaped_new_uri_registersCourse/g" globalvocab_datasets/University$suffix.nt

  sed -i -e "s/$escaped_old_uri_headOf/$escaped_new_uri_worksAt/g" globalvocab_datasets/University$suffix.nt

  sed -i -e "s/$escaped_old_uri_GraduateCourse/$escaped_new_uri_course/g" globalvocab_datasets/University$suffix.nt

  grep "$escaped_old_uri_GraduateStudent" globalvocab_datasets/University$suffix.nt | sed "s/$escaped_old_uri_GraduateStudent/$escaped_new_uri_GraduateStudent/g" >> globalvocab_datasets/University$suffix.nt
  grep "$escaped_old_uri_GraduateStudent" globalvocab_datasets/University$suffix.nt | sed "s/$escaped_old_uri_GraduateStudent/$escaped_new_uri_Student/g" >> globalvocab_datasets/University$suffix.nt

  sed -i -e "/${escaped_old_uri_GraduateStudent}/d" globalvocab_datasets/University$suffix.nt
